...
class ProfilePicform(forms.ModelForm):
    ...
    class Meta:
        model = Profile
        fields = ('profile_image','back_image', 'born_date', 'profile_bio', 'homepage_link', 'facebook_link', 'instagram_link', 'linkedln_link',)

class MeepForm(forms.ModelForm):
    body = forms.CharField(required=True,
                           widget=forms.widgets.Textarea(
                               attrs={"placeholder": "What is happening?!", 
                                      "class":"form-control", 
                                      "style": """
    ...
    class Meta:
        model = Meep
        exclude = ("user","likes","bookmarks",)
        
        
class CommentForm(forms.ModelForm):
    comment = forms.CharField(required=True,
                           widget=forms.widgets.Textarea(
                               attrs={"placeholder": "Post an Answer", 
